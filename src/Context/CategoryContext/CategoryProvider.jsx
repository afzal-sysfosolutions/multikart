...
const CategoryProvider = (props) => {
  ...
  const filterCategory = (value) => {
    return data?.filter((elem) => elem.type === value) || [];
  };
  ...
  return <CategoryContext.Provider value={{ ...props, categoryAPIData, setCategoryAPIData, filterCategory: filterCategory, data }}>{props.children}</CategoryContext.Provider>;
};
