...
const SettingProvider = (props) => {
  ...
  // useEffect(() => {
  //   if ( SettingData?.content) {
  //     refetch();
  //     if ( SettingData?.content?.maintenance?.maintenance_mode) {
  ...
  const convertCurrency = useCallback(
    ...
    return null;  // let position = selectedCurrency?.symbol_position ? selectedCurrency?.symbol_position : settingObj?.general?.default_currency?.symbol_position || "before_price";
  ...
  return <SettingContext.Provider value={{ ...props, settingData, convertCurrency, selectedCurrency, setSelectedCurrency, menuLoader,  setMenuLoader }}>{props.children}</SettingContext.Provider>;
};
