...
const HeaderOne = () => {
  ...
  const { themeOption, setOpenAuthModal, openAuthModal, mobileSideBar, setMobileSideBar, modalState, setmodalState } = useContext(ThemeOptionContext);
                  ...
                  <div>
                    <div className="icon-nav">
                      <ul>
                        ...
                        <li className="onhover-div">
                          <Link href={clientId ? "/wishlist" : Href} onClick={()=> !clientId ? setOpenAuthModal(true) : null}>
                            <RiHeartLine />
                          </Link>
                        </li>
                        <li className="onhover-div">
                        ...
                        <li className="onhover-div">
                      <Link href={clientId ? "/account/dashboard" : Href} onClick={()=> !clientId ? openLoginModal(): null}>
                        <RiUserLine />
                      </Link>
                    </li>
                      </ul>
