...
const ShowCartData = () => {
  const { getTotal, cartProducts, setrefreshCart, refreshCart} = useContext(CartContext);
          ...
          <Col xs={12}>
            <div className="table-responsive">
              <Table className="cart-table">
                ...
                <tfoot>
                  <tr>
                    <td colSpan="6" className="d-md-table-cell d-none">
                      {t("TotalPrice")} : ₹{cartProducts[0]?.GrandTotal}
                    </td>
                    {/* <td className="d-md-none">{t("TotalPrice")} :{cartProducts[0]?.GrandTotal}</td>
                    <td>
