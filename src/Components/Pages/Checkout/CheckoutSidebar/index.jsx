      ...
      <Col lg="5">
        {cartProducts?.length > 0 ? (
          <div className="checkout-right-box">
            ...
            <BillingSummary values={values} errors={errors} setFieldValue={setFieldValue} data={resData} errorCoupon={errorCoupon} appliedCoupon={appliedCoupon} setAppliedCoupon={setAppliedCoupon} storeCoupon={storeCoupon} setStoreCoupon={setStoreCoupon}  addToCartData={addToCartData} />
          </div>
        ) : (
