...
const CollectionSidebar = ({CategoryData, BrandList, filter, setFilter, isOffcanvas, basicStoreCard, rightSideClass, sellerClass, isAttributes = true, hideCategory, categorySlug }) => {
            ...
            {/* {!isOffcanvas && <CollectionFilter filter={filter} setFilter={setFilter} categorySlug={categorySlug} />} */}
                <Accordion className={`collection-collapse-block open  ${isOffcanvas ? "row" : ""}`} open={open} toggle={toggle}>
                  ...
                  <AccordionHeader targetId="1" className="collapse-block-title">
                      ...
                      <CollectionCategory filter={filter} setFilter={setFilter} filterData={CategoryData}/>
                    </AccordionItem>
                  <AccordionItem className={`collection-collapse-block open ${isOffcanvas ? "col-lg-3" : ""}`}>
                    <AccordionHeader targetId="2" className="collapse-block-title">
                      <span>{t("Brand")}</span>
                    </AccordionHeader>
                    <CollectionBrand filter={filter} setFilter={setFilter} BrandList={BrandList}/>
                  </AccordionItem>
                  <CollectionPrice isOffCanvas={isOffcanvas} filter={filter} setFilter={setFilter} attributeAPIData={[]} />
                  {/* <CollectionRating isOffCanvas={isOffcanvas} filter={filter} setFilter={setFilter} attributeAPIData={[]} /> */}
                </Accordion>
          </div>
        </div>
      </div>
