...
const MainCollection = ({callApi, filter, setFilter, isBanner, isOffcanvas, classicStoreCard, initialGrid = 3, noSidebar, sellerClass, sidebarPopUp, infiniteScroll, categorySlug, noSort, noPagination, CollectionData }) => {
        ...
        <Row>
          <Col xs="12">
            ...
            <div className="collection-product-wrapper">
              ...
              <CollectionProducts filter={filter} grid={grid} infiniteScroll={infiniteScroll} setFilter={setFilter} categorySlug={categorySlug} products={CollectionData} callApi={callApi}/>
            </div>
          </Col>
        </Row>
      </div>
