        ...
        <div className="product-detail">
          ...
          <h4 className="price">
                 ...
                 <span className="discounted-price">
                  {calculateDiscountPercentage(productState?.product?.UsualPrice, productState?.product?.ProductPrice)}% Off
                </span>
          </h4>
          <ul className="offer-panel">
                    <li>
                      ...
                      Limited Time Offer: {calculateDiscountPercentage(productState?.product?.UsualPrice, productState?.product?.ProductPrice)} off
                    </li>
                    <li>
                      <span className="offer-icon">
                        <svg
