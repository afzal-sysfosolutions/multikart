...
const NavTabTitles = ({ classes = {}, activeTab, setActiveTab, titleList, isLogout, callBackFun }) => {
  ...
  const { mobileSideBar, setMobileSideBar, setisLogin, isLogin, setAccountData, setClientId} = useContext(AccountContext);
  ...
  const handleLogout = () => {
    ...
    setClientId(null);
    setisLogin(!isLogin);
    ToastNotification('success', "You have successfully logged out.")
  };
