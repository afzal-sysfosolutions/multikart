...
export const passwordSchema = Yup.string().min(5, "Too Short!").max(20, "Too Long!").required();
export const nameSchema = Yup.string().required(" Full Name is Required");
...
export const Pincode = Yup.number().required("Pincode is Required.");
